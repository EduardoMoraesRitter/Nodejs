...
//dinamico controller, por conta do escopo ele nao sabe quem é o this, dando um bind para ele lembrar
router.post('/products', ProductsController.create.bind(ProductsController));//http://localhost:3000/products
